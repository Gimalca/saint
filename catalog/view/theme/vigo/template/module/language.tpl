		...
		<div id="language" style="left:215px;"><span style="margin-bottom:5px;"></span>
			...
			<?php foreach ($languages as $language) { ?>
            	<?php if ($language['code'] == $language_code) { ?>
                    	<option class="option" selected value="<?php echo $language['code']; ?>" data-image="image/flags/<?php echo $language['image']; ?>"><?php echo $language['name']; ?></option>
            	<?php }else{  ?>
                    	<option class="option" value="<?php echo $language['code']; ?>" data-image="image/flags/<?php echo $language['image']; ?>"><?php echo $language['name']; ?></option>
				<?php } ?>
            <?php } ?>
            </select>
