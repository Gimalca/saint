        ...
        <div class="col-main col-md-9 col-sm-8 col-xs-12">
            ...
            <div class="limiter">
                ...
                <div class="toolbar-bottom">
                    <div class="toolbar">
                        <div class="pager"><?php echo $pagination; ?>
                            <!--<div class="limiter">
                                <label><?php echo $text_limit; ?></label>
                                <select onchange="location = this.value;">
                                <?php foreach ($limits as $limits) { ?>
...
function display(view) {
            ...
            $(element).html(html);
                    ...
                    $('.view-mode').html('<label><?php echo $text_display; ?></label> <a class="list" title="list" onclick="display(\'grid\'); "><?php echo $text_list; ?></a> <strong class="grid" title="grid"><?php echo $text_grid; ?></strong>');
