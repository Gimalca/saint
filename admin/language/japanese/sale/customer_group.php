<?php
// Heading
$_['heading_title']    = '顧客グループ';

// Text
$_['text_success']     = '成功: 顧客グループを修正しました。';

// Column
$_['column_name']      = '顧客グループ名';
$_['column_sort_order']         = '表示順';
$_['column_action']    = 'アクション';

// Entry
$_['entry_name']       = '顧客グループ名:';
$_['entry_description']    = '説明';
$_['entry_approval']    = '商品';
$_['entry_company_id_display']    = '法人ID表示';
$_['entry_company_id_required']    = '法人ID必須';
$_['entry_tax_id_display']    = 'TAX ID表示';
$_['entry_tax_id_required']    = 'TAX ID必須';
