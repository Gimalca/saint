...
// Text
$_['text_success']       = '成功: バナーの修正を保存しました。';
$_['text_default']       = 'デフォルト';
$_['text_image_manager'] = 'イメージマネージャ';
$_['text_browse']        = 'ファイル参照';
...
// Error
$_['error_permission']   = 'Warning: バナーを保存するためのパーミッションがありません。';
$_['error_name']         = 'バナー名は3文字以上64文字以内で作成してください。';
$_['error_title']        = 'バナータイトルは2文字以上64文字以内で作成して下さい。';
