...
$_['entry_dimension']       = 'Διαστάσεις (Μ x Π x Υ):<br /><span class="help">Οι μέσες διαστάσεις πακέτων αποστολής. Διαστάσεις προϊόντων δεν υποστηρίζονται προς το παρόν.</span>';
...
$_['entry_weight_class']    = 'Κλάση Βάρους:<br /><span class="help">Ορίζεται σε λίβρες (pounds).</span>';
