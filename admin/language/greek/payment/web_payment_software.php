...
// Error 
$_['error_permission']          = 'Ειδοποίηση: Δεν έχετε άδεια να επεξεργαστείτε τη πληρωμή Web Payment Software!';
$_['error_login']               = 'Απαιτείται το Login ID!';
$_['error_key']                 = 'Απαιτείται το Transaction Key!';
?>